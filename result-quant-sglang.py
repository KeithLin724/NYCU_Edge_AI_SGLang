...
def main(model_name: str):
    ...
    model = SgLangModel(model_name=model_name)
    #####################################
    ...
    for i in tqdm(range(5), desc="Warm Up..."):
        ...
        # )
        model.openai_request("Explain what AI is.", max_tokens=max_new_tokens)
    ...
    for _ in tqdm(range(10), desc="Test Inference"):
        ...
        generated = model.openai_request(
            "How to learn a new language?", max_tokens=max_new_tokens
        )
        ...
        total_token = generated.usage.completion_tokens
        tput = total_token / (elapsed_ms / 1000)
